...
Treat `docs/terraform-standards.md` as the canonical source of truth for naming, file layout, variable and output conventions, comment style, required repository files, and validation workflow.
